...
(function ($, _, undefined) {
    ...
    var defaultSettings = {
        ...
        templates     : {
            wrapper                    : _.template('<div class="mentions-input-box w-100"></div>'),
            ...
            mentionItemHighlight       : _.template('<strong><span class="fw-bold bubble"><%= value %></span></strong>')
        }
    };
        ...
        function populateDropdown(query, results) {
            ...
            _.each(results, function (item, index) {
                ...
                var elmListItem = $(settings.templates.autocompleteListItem({
					...
					'rutbe'    : utils.htmlEncode(item.rutbe),
